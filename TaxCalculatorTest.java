...
public class TaxCalculatorTest extends TestCase {
    ...
    @Test
    public void testNameSetter () throws Exception
    {
        assertEquals("John Smith", t.getName());
    }

    @Test
    public void testNameGetter() throws Exception
    {
    ...
    /**
     * tests exceptions thrown by constructor on bad names
     * @throws Exception
     */
    @Test
    public void testBadNameConstructor() throws Exception
    {
        try
        {
            TaxCalculatorInterface tmp = new TaxCalculator("", TaxCalculatorInterface.SINGLE,
                    20);
            fail("should throw exception for empty string name");
        }
        catch (Exception e) {}

        try
        {
            TaxCalculatorInterface tmp = new TaxCalculator("Walter", TaxCalculatorInterface.SINGLE,
                    20);
            fail("should throw exception for just 1 token in name");
        } catch (Exception e) {}

        try
        {
            TaxCalculatorInterface tmp = new TaxCalculator("", TaxCalculatorInterface.MARRIED_FILING_JOINTLY,
                    20, 40);
            fail("should throw exception for empty string name");
        } catch (Exception e) {}
        ...
        try
        {
            TaxCalculatorInterface tmp = new TaxCalculator("Walter", TaxCalculatorInterface.MARRIED_FILING_JOINTLY,
                    20, 40);
            fail("should throw exception for just 1 token in name");
        } catch (Exception e) {}
    }
    ...
    @Test
    public void testBadAgeConstructor() throws Exception
    {
        try
        {
            TaxCalculatorInterface tmp = new TaxCalculator("Derek Jeter", TaxCalculatorInterface.SINGLE,
                    0);
            fail("should throw exception for 0 age");
        } catch (Exception e) {}
    }
    ...
    @Test
    public void testTaxCalculationQualWidower() throws Exception
    {
        TaxCalculatorInterface t1;
        t1 = new TaxCalculator("Mary Beth",
                TaxCalculatorInterface.QUALIFYING_WIDOWER,
                55);
    ...
    public void testLongConstructor() throws Exception {
        ...
        try {
            t = new TaxCalculator("John Adams",
                    TaxCalculatorInterface.MARRIED_FILING_JOINTLY, 31, 0);
            fail();
        } catch (Exception ex) {
        }
        try {
            t = new TaxCalculator("John Adams",
                    TaxCalculatorInterface.MARRIED_FILING_JOINTLY, 31, -1);
            fail();
        } catch (Exception ex) {
        }
    }
...
//        assertEquals(0, t2.getNetTaxRate(), 0.001);
    ...
    public void testGetTaxableIncome() throws Exception {
        ...
        assertEquals(8024, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(13475);
        t2.setGrossIncome(14525);
        assertEquals(8025, t1.getTaxableIncome(), 0.01);
        assertEquals(8025, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(13476);
        t2.setGrossIncome(14526);
        assertEquals(8026, t1.getTaxableIncome(), 0.01);
        assertEquals(8026, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(37999);
        t2.setGrossIncome(39049);
        assertEquals(32549, t1.getTaxableIncome(), 0.01);
        assertEquals(32549, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(38000);
        t2.setGrossIncome(39050);
        assertEquals(32550, t1.getTaxableIncome(), 0.01);
        assertEquals(32550, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(38001);
        t2.setGrossIncome(39051);
        assertEquals(32551, t1.getTaxableIncome(), 0.01);
        assertEquals(32551, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(84299);
        t2.setGrossIncome(85349);
        assertEquals(78849, t1.getTaxableIncome(), 0.01);
        assertEquals(78849, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(84300);
        t2.setGrossIncome(85350);
        assertEquals(78850, t1.getTaxableIncome(), 0.01);
        assertEquals(78850, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(84301);
        t2.setGrossIncome(85351);
        assertEquals(78851, t1.getTaxableIncome(), 0.01);
        assertEquals(78851, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(169999);
        t2.setGrossIncome(171049);
        assertEquals(164549, t1.getTaxableIncome(), 0.01);
        assertEquals(164549, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(170000);
        t2.setGrossIncome(171050);
        assertEquals(164550, t1.getTaxableIncome(), 0.01);
        assertEquals(164550, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(170001);
        t2.setGrossIncome(171051);
        assertEquals(164551, t1.getTaxableIncome(), 0.01);
        assertEquals(164551, t2.getTaxableIncome(), 0.01);
        t1.setGrossIncome(363149);
        t2.setGrossIncome(364199);
    ...
    public void testStandardDeduction() throws Exception {
        ...
        t = new TaxCalculator("John Adams",
                TaxCalculatorInterface.MARRIED_FILING_JOINTLY, 64, 65);
        assertEquals(10900 + 1050, t.getStandardDeduction(), 0.01);

        t = new TaxCalculator("John Adams",
                TaxCalculatorInterface.MARRIED_FILING_JOINTLY, 65, 64);
        assertEquals(10900 + 1050, t.getStandardDeduction(), 0.01);
    ...
    public void testReturnRequired() throws Exception {
        ...
        t = new TaxCalculator("John Adams",
                TaxCalculatorInterface.MARRIED_FILING_SEPARATELY, 31, 31);
        t.setGrossIncome(3499);
        assertEquals(false, t.isReturnRequired());

        t.setGrossIncome(3500);
        assertEquals(true, t.isReturnRequired());

        t.setGrossIncome(3501);
        assertEquals(true, t.isReturnRequired());

        t = new TaxCalculator("John Adams",
                TaxCalculatorInterface.MARRIED_FILING_SEPARATELY, 66, 31);
        t.setGrossIncome(3501);
        assertEquals(true, t.isReturnRequired());
